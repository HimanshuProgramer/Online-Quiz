...
<body style="margin:4px;background-color:#0B91AA;" >
    <nav class="navbar navbar-default title1">
        ...
        <a class="navbar-brand" href="#"><b>Online Quiz Application System</b></a>
        </div>
		...
		<?php
			$qq=mysqli_query($con,"SELECT name FROM user WHERE email='$email'" )or die('Error98');
			$row=mysqli_fetch_array($qq);
			$name=$row['name'];
		?>
			<li style="font-weight:bold;text-align:center;font-size:25px;padding:5px;">User Name: <?php echo $name ?></li>
