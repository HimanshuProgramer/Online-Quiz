...
<body style="margin:4px;background-color:#0B91AA;" >
    <nav class="navbar navbar-default title1">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="Javascript:void(0)"><b>Online Quiz Application System</b></a>
            </div>
            ...
            <div class="col-md-12">
                <?php if(@$_GET['q']==0)
                {
                   echo "<h1> WELCOME TO Admin Page!!
					...
					<p style='text-align:justify;word-spacing:7px;margin-left:80px;margin-right:80px;padding:10px;font-size:25px;'>
					Today Online Quiz Application System has become a fast growing examination method because of its speed and accuracy. It is also needed less manpower to execute the examination. 
					Almost all organizations now-a-days, are conducting their objective exams by online examination 
					or quiz system, it saves students time in examinations. Organizations can also easily check the
									...
									<div class="table-responsive">
										<table class="table table-striped title1">
											<tr>
												...
												<td><center><b>Total question</b></center>
												</td><td><center><b>Marks</b></center></td>
												<td><center><b>Action</b></center></td>
											</tr>';
                        $c=1;
                        while($row = mysqli_fetch_array($result)) {
